...
public partial class @InputActions : IInputActionCollection2, IDisposable
{
    ...
    public struct PCInputActions
    {
        ...
        public void SetCallbacks(IPCInputActions instance)
        {
            ...
            {
                @MouseMovement.started -= m_Wrapper.m_PCInputActionsCallbackInterface.OnMouseMovement;
                @MouseMovement.performed -= m_Wrapper.m_PCInputActionsCallbackInterface.OnMouseMovement;
                @MouseMovement.canceled -= m_Wrapper.m_PCInputActionsCallbackInterface.OnMouseMovement;
            }
